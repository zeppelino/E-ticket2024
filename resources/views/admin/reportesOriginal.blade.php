                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Filtros de Reportes -->
                            <form method="GET" 
                            action="{{ route('reportePDF') }}" }} 
                            class="mb-4"
                            target="_blank"
                            name='nameReporteForm'
                            id="reporteForm">
                                @csrf
                                <div class="mb-4" >
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select form-select-sm" id="tipo_reporte" name="tipo_reporte">
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="fecha_desde" name="fecha_desde" {{--  min="{{ \Carbon\Carbon::now()->format('Y-m-d') }} "--}}required>
                                            </div>
                                            
                                            <!-- Fecha Hasta -->
                                            <div class="col-md-2 mb-3">
                                                <label for="fecha_hasta" class="form-label">Hasta</label>
                                                <input type="date" class="form-control form-control-sm" id="fecha_hasta" name="fecha_hasta" {{--  min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" --}}required>
                                                <small id="dateError" class="text-danger" style="display: none;">La fecha "Hasta" no puede ser menor que la fecha "Desde".</small>
                                            </div>
                                ...
                                <table class="table table-bordered table-striped tablaReporte" id="tablaAnual">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $evento->tipoTickets->sum('cupoTotal') }}</td> <!-- Total de entradas -->
                            
                                            <!-- Entradas Vendidas -->
                                            <td>{{ $evento->tipoTickets->sum(function ($tipoTicket) { 
                                                return $tipoTicket->cupoTotal - $tipoTicket->cupoDisponible; 
                                            }) }}</td> 
                            
                                            <!-- Entradas No Vendidas -->
                                            <td>{{ $evento->tipoTickets->sum('cupoDisponible') }}</td> 
                            
                                            <td>{{ $evento->cancelados ?? 0 }}</td> <!-- aca poner cuantos quisieron comprar pero no pudieron -->
                                        </tr>
                                    @endforeach
